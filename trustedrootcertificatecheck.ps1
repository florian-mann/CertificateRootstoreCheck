$SkriptVersion = "0.2 vom 01.09.2020"
...
.SYNOPSYS
 ...
 Version 0.2 vom 01.09.2020, AUTHOR: FLORIAN MANN
...

{
    ...
    #Funktion gleich lokalen Store mit CTL ab
    ...
    {   
        ...
        $LokaleZertifikate = $LokaleZertifikate | Sort-Object -Property FriendlyName
...

         {
            ...
            #ListViewItem Variable für die zwischenspeicherung der Werte erstellen (inkl. erstem leeren Element)
...
$objListBoxZertifikate.MultiSelect = $true
    ...
    #Spaltenüberschrift für ListView
...
$labelHilfe  = New-Object Windows.forms.Label # Label erzeugen

$Hilfetext = "`nAblauf Datei Kopieren:"
...
$TabCTL.Controls.AddRange(($labelHilfe))
